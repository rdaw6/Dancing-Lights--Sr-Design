...
#csv_filename = "C:\\Users\\LattePanda\\Desktop\\Dancing-Lights--Senior-Design\\Macros\\variables.csv"

# Function to load variables from CSV file
def load_variables_from_csv(csv_file_path):
    global macro_select, Brightness, speed, color_scheme, colors, scheme_1, scheme_2, scheme_3, scheme_4, color_options, special_macro
    ...
    with open(csv_file_path, 'r') as csvfile:
        ...
        for i, row in enumerate(reader):
            ...
            if variable_name == "Brightness" or variable_name == "color_scheme":
                value = int(value)
            elif variable_name == "speed":
                value = int(value)
            elif variable_name == "macro_select":
                macro_select[0] = v1
                macro_select[1] = v2
                
            #if variable_name == "macro_select":
                #macro_select = value
            if variable_name == "Brightness":
                Brightness = value
            elif variable_name == "speed":
                speed = value
...
csv_file_path = "C:\\Users\\LattePanda\\Desktop\\Dancing-Lights--Sr-Design-main\\Macros\\variables.csv"
load_variables_from_csv(csv_file_path)
